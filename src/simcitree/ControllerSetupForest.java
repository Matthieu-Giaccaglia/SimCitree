...
public class ControllerSetupForest {
    ...
    public void addArbre() throws IOException {
        ...
        if (rayonDisp.equals("") || rayonComp.equals("") || tauxReprod.equals("") || tauxMort.equals("") || tauxComp.equals("") || nbArbre.equals("")) {
            ...
            Main.foret = new Foret(Double.parseDouble(rayonDisp), Double.parseDouble(rayonDisp), Double.parseDouble(tauxReprod), Double.parseDouble(tauxMort), Double.parseDouble(tauxComp) ,Integer.parseInt(nbArbre));
            Main.stage.close();
